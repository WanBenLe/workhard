...
import pandas as pd
import numpy as np
from slopeklevel import slope3level, slope2level, DSSlope
...
pickle.dump(Set_1, open('Set_1.py', 'wb'))
pickle.dump(Set_2, open('Set_2.py', 'wb'))
pickle.dump(Set_all, open('Set_all.py', 'wb'))
pickle.dump(st, open('st.py', 'wb'))
pickle.dump(sr, open('sr.py', 'wb'))
...
# z1 = z[:, [0, 2, 3, 4, 5, 6, 7, 10, 11, 12, 13, 15, 16, 17, 20, 21, 22, 23, 24, 25, 26, 27, 29, 30]]
y = d1[:, 2].reshape(-1, 1)
