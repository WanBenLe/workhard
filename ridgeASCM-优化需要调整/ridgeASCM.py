...
"""
一般来说,在做AB测试的时候,如果不摞GMM或者IV以工具变量的方法进行估计,PSM-DID是一个解决内生性问题的良好工具(PSM方法上面给出)
但是对于DID来说由于控制组只能选取一个,具有较大的个人主观性(结果容易操纵)和同质性假设强
...
The Augmented Synthetic Control Method, Eli Ben-Michael, NBER, 2021
